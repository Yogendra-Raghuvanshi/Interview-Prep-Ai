...
const SummaryCard = ({
  ...
  return (
    <div 
      className="bg-white border border-gray-300/40 rounded-xl p-1 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
      onClick={onSelect}  
    >
      <div 
      ...
      <button 
        className="hidden group-hover:flex items-center gap-2 text-xs text-white font-medium bg-rose-500 px-3 py-1 rounded absolute top-2 right-2"
        onClick={(e) => {
          e.stopPropagation();
          onDelete();
        }}
